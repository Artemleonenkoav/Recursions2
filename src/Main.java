...
// В соревнованиях по дартс принимают участие 3 команды. В каждой команде по 4 участника. У каждого участника есть 3 попытки. Количество очков, которое получает каждый участник за один бросок, вводится с клавиатуры. Максимальное количество очков за 1 попытку – 60. Отобразите победителя (т.е. номер участника, набравшего наибольшее количество очков, и его результат) от каждой команды. Участник какой команды показал лучший результат?
